                    ...
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                                ...
                                <ul class="slides"
                                    ...
                                    <li data-thumb="images/si3.jpg" class="clone" aria-hidden="true"
                                        ...
                                        <div class="thumb-image">
                                            <img src="{{asset('client/images/si3.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""
                                                draggable="false"> </div>
                                    </li>
                                    <li data-thumb="{{asset('client/images/si1.jpg')}}"
                                        ...
                                        <div class="thumb-image">
                                            <img src="{{asset('client/images/si1.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""
                                                draggable="false"> </div>
                                    </li>
                                    <li data-thumb="{{asset('client/images/si2.jpg')}}" data-thumb-alt="" class=""
                                        style="width: 437px; margin-right: 0px; float: left; display: block;">
                                        <div class="thumb-image">
                                            <img src="{{asset('client/images/si2.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""
                                                draggable="false"> </div>
                                    </li>
                            ...
                            <ol class="flex-control-nav flex-control-thumbs">
                                <li><img src="{{asset('client/images/si1.jpg')}}" class="flex-active" draggable="false"></li>
                ...
                <div class="col-md-6 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="product-single-w3l">
                        <p class="my-3">
                            ...
                            <label>{{ trans('product_detail.1 Year') }}</label>{{ trans('product_detail.Manufacturer Warranty') }}</p>
                        <ul>
                        ...
                        <p class="my-sm-4 my-3">
                            <i class="fas fa-retweet mr-3"></i>{{ trans('product_detail.Net banking Credit/ Debit/ ATM card') }}
                        </p>
                    </div>
