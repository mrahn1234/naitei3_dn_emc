<footer>
    <div class="footer-top-first">
        <div class="container py-md-5 py-sm-4 py-3">
            ...
            <h2 class="footer-top-head-w3l font-weight-bold mb-2">{{ trans('footer.Electronics :') }}</h2>
            <p class="footer-main mb-4">{{ trans('footer.description') }}</p>
            <!-- //footer first section -->
            ...
            <div class="row w3l-grids-footer border-top border-bottom py-sm-4 py-3">
                <div class="col-md-4 offer-footer">
                    <div class="row">
                        ...
                        <div class="col-8 text-form-footer">
                            <h3>{{ trans('footer.freeShip') }}</h3>
                            <p>{{ trans('footer.onOrder') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 offer-footer">
                    <div class="row">
                        ...
                        <div class="col-8 text-form-footer">
                            <h3>{{ trans('footer.big') }}</h3>
                            <p>{{ trans('footer.ofProduct') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-md-5 py-sm-4 py-3">
            <div class="row footer-info w3-agileits-info">
                ...
                <div class="col-md-3 col-sm-6 footer-grids">
                    <h3 class="text-white font-weight-bold mb-3">{{ trans('footer.Categories') }}</h3>
                    <ul>
                        <li class="mb-3">
                ...
                <div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
                    <h3 class="text-white font-weight-bold mb-3">{{ trans('footer.quickLink') }}</h3>
                    <ul>
                        <li class="mb-3">
                            <a href="about.html">{{ trans('footer.aboutUs') }}</a>
                        </li>
                        <li class="mb-3">
                            <a href="contact.html">{{ trans('footer.contact') }}</a>
                        </li>
                        <li class="mb-3">
                            <a href="help.html">{{ trans('footer.help') }}</a>
                        </li>
                        <li class="mb-3">
                            <a href="faqs.html">{{ trans('footer.Faqs') }}</a>
                        </li>
                        <li class="mb-3">
                            <a href="terms.html">{{ trans('footer.terms-of-use') }}</a>
                        </li>
                        <li>
                            <a href="privacy.html">{{ trans('footer.privacy') }}</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
                    ...
                    <div class="footer-grids  w3l-socialmk mt-3">
                        <h3 class="text-white font-weight-bold mb-3">{{ trans('footer.follow') }}</h3>
                        <div class="social">
                            <ul>
                                <li>
